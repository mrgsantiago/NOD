...
extend(flowplayer, {
   ...
   defaults: {
      ...
      swf: "//releases.flowplayer.org/7.2.0/flowplayer.swf",
      swfHls: "//releases.flowplayer.org/7.2.0/flowplayerhls.swf",
      ...
      if (!root.getAttribute('data-flowplayer-instance-id')) { // Only bind once
         ...
         api.on('boot', function() {
           ...
           api.splash = !is_ready;
            ...
            api.video.buffer = buffered[buffered.length - 1].end;
         }).on("speed", function(e, api, val) {
